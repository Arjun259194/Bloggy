  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] bg-gradient-to-t from-sky-100 to-gray-100 text-gray-900 max-w-full relative rounded-2xl border flex-shrink-0 border-gray-200 px-8 py-6 md:w-[450px]"
            key={idx}
          >
            <blockquote>
              <div
